	...
	if(!sig_id || !type || !protocol || !manual || !msg || sig_id == null || sig_id == ""){
		...
		if (person == null || person == "" || person == "No. of Rule ID") {
			...
			if(!manual || manual == null || manual == 0){
				...
				$.post("http://localhost:3001/addrule/addRule2", 
					{Type:type,Protocol:protocol,Sig_id:sig_id,Color:color,Msg:msg,Manual:manual}).then(function(res,status){
						console.log("pass")
						if(res.success=="true"){
							alert(res.message)
...
function editRule(){	
	...
	$(document).ready(function(){
	$.post("http://localhost:3001/addrule/editRule2", 
...
function useRule(){	
	...
	// console.log("pass"+type+" "+sid)
	$(document).ready(function(){
	$.post("http://localhost:3001/addrule/useRule2", 
...
function unuseRule(){	
	...
	// console.log("pass"+type+" "+sid)
	$(document).ready(function(){
	$.post("http://localhost:3001/addrule/unuseRule2", 
...
function deleteRule(){	
				...
				// console.log("pass"+type+" "+sid)
				$(document).ready(function(){
				$.post("http://localhost:3001/addrule/sid_delete2", 
