				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="add_rule3.php">Add Rule : Raspberry Pi 3</a>
							</li>
						</ul><!-- /.breadcrumb -->
...
<!--  Body  -->
  ...
  <form method="post" action="./snorpy_rule3.php">  
 <div class="col-sm-12">
...
<!-- Edit Rule (Drop & Alert) : Raspberry Pi 3 -->
<div class="rulebody">
    <form action="./snorpy_rule3.php" >
        <!-- Add Rule : BlankSpace -->
		<div class="col-sm-12">
				<br><br><br><br>
				<div class="center">- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -</div>
        ...
        <h4>Edit Rule : Raspberry Pi 3</h4>
        <div class="col-sm-12">
            <br><br> Type Action : 
...
<div >
    <form method="post" action="./snorpy_rule3.php">
        ...
        <h4>Modify Rule Use/Unuse : Raspberry Pi 3</h4>
        <div class="col-sm-12">
...
<div class="rulebody">
    <form action="./snorpy_rule3.php">
        ...
        <h4>Delete Rule : Raspberry Pi 3</h4>
        <div class="col-sm-12">
            <br><br> Signature ID : 
...
function editRule(){	
	...
	$.post("http://localhost:3001/addrule/editRule1", 
			{type:type,sid:sid}).then(function(res,status){
				if(err){
								// alert(err)
							}else{
								alert(status)
...
function useRule(){	
	...
	$.post("http://localhost:3001/addrule/useRule1", 
			{sid:sid_use}).then(function(res,status){
				if(err){
								// alert(err)
							}else{
								alert(status)
...
function unuseRule(){	
	...
	$.post("http://localhost:3001/addrule/unuseRule1", 
			{sid:sid_unuse}).then(function(res,status){
				if(err){
								// alert(err)
							}else{
								alert(status)
...
//Modify Rule Delete
	function deleteRule(){	
		...
		// console.log("pass"+type+" "+sid)
		$(document).ready(function(){
		$.post("http://localhost:3001/addrule/sid_delete3", 
				{Sig_id:sid_delete}).then(function(res,status){
					if(err){
								// alert(err)
							}else{
								alert(status)
